...
class Functions:
    ...
    def generate_excel_files(eng_file_path,data_dir_path):
        eng_file_path='data'
        data_dir_path='data//en-US.jsonl'
        list_of_files = os.listdir(eng_file_path)
        english_data = pd.read_json(data_dir_path, lines=True)
        for file_name in list_of_files:
            ...
            if language != 'en-US':
                ...
                if os.path.isdir('generated_files//excel'):
                    ...
                    os.mkdir('generated_files//excel')
                    en_xx.to_excel('generated_files//excel//en-'+xx+'.xlsx')
